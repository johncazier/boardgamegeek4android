...
class LocationsActivity : ComponentActivity() {
                ...
                Scaffold(
                                ...
                                Box {
                                    ...
                                    DropdownMenu(
                                        ...
                                        DropdownMenuItem(
                                            ...
                                            trailingIcon = {
                                                if (sortType == Location.SortType.NAME) {
                                                    Text("\u2713")
                                                }
                                            }
                                        )
                                        DropdownMenuItem(
                                            ...
                                            trailingIcon = {
                                                if (sortType == Location.SortType.PLAY_COUNT) {
                                                    Text("\u2713")
                                                }
                                            }
                                        )
                    ...
                    LocationsScreen(
                        ...
                        onLocationClick = { locationName ->
                            com.boardgamegeek.ui.plays.LocationActivity.start(this, locationName)
                        }
                    )
                }
            }
    ...
    companion object {
        fun start(context: Context) {
            context.startActivity<LocationsActivity>()
        }
    }
}
