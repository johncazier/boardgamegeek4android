...
import com.boardgamegeek.ui.category.CategoryActivity
                ...
                Scaffold(
                                ...
                                Box {
                                    ...
                                    DropdownMenu(
                                        ...
                                        DropdownMenuItem(
                                            ...
                                            onClick = {
                                                startActivity(Intent(this@CategoriesActivity, SearchResultsActivity::class.java))
                                                showOverflowMenu = false
                                            }
                                        )
                                    }
                    ...
                    CategoriesScreen(
                        ...
                        onCategoryClick = { category ->
                            CategoryActivity.start(this, category.id, category.name)
                        }
                    )
                }
            }
