...
object BuddyCollectionActivity {
    ...
    AppTheme {
        Scaffold(
                            ...
                            IconButton(
                                onClick = {
                                    collection.randomOrNull()?.let { randomItem ->
                                        GameActivity.start(context, randomItem.gameId, randomItem.gameName, randomItem.thumbnailUrl)
                                    }
                                },
                            ) {
                                Icon(
            ...
            BuddyCollectionScreen(
                ...
                onGameClick = { item ->
                    GameActivity.start(context, item.gameId, item.gameName, item.thumbnailUrl)
                },
            )
        }
    }
