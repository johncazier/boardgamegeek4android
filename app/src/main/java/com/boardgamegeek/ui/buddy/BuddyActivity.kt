...
import com.boardgamegeek.ui.playercolors.PlayerColorsActivity
    ...
    AppTheme {
        Scaffold(
            ...
            BuddyScreen(
                ...
                onOpenCollection = {
                    BuddyCollectionActivity.start(context, currentUsername)
                },
                onOpenPlays = {
                    if (currentUsername.isNullOrBlank()) {
                        PlayerPlaysActivity.start(context, currentPlayerName)
                    } else {
                        BuddyPlaysActivity.start(context, currentUsername)
                    }
                },
                onOpenColors = {
                    PlayerColorsActivity.start(context, currentUsername, currentPlayerName)
                },
