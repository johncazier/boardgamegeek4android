...
@AndroidEntryPoint
class DesignersActivity : ComponentActivity() {
        ...
        setContent {
            AppTheme {
                ...
                Scaffold(
                    topBar = {
                        TopAppBar(
                            title = { Text(stringResource(R.string.title_designers)) },
                            navigationIcon = {
                            ...
                            actions = {
                                Text(
                                    text = (designers?.size ?: 0).toString(),
                                ...
                                Box {
                                    ...
                                    DropdownMenu(
                                        ...
                                        DropdownMenuItem(
                                            ...
                                            onClick = {
                                                startActivity(Intent(this@DesignersActivity, SearchResultsActivity::class.java))
                                                showOverflowMenu = false
                                            }
                                        )
                                    }
                    ...
                    DesignersScreen(
                        ...
                        onDesignerClick = { designer ->
                            PersonActivity.startForDesigner(this, designer.id, designer.name)
                        }
                    )
                }
            }
