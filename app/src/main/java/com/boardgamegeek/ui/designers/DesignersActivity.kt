...
@Composable
fun DesignersRouteScreen(
    viewModel: DesignersViewModel = hiltViewModel(),
) {
        ...
        Scaffold(
            ...
            DesignersScreen(
                ...
                onDesignerClick = { designer ->
                    PersonActivity.startForDesigner(context, designer.id, designer.name)
                },
            )
        }
    }
