...
fun LogPlayRouteScreen(
    ...
    LaunchedEffect(pendingPlayerRequestId) {
        ...
        when {
            result.position == LogPlayerActivity.INVALID_POSITION && result.player != null -> {
    ...
    fun createLaunchInput(autoPosition: Int): LogPlayerActivity.LaunchInput {
        return LogPlayerActivity.LaunchInput(
            gameId = route.gameId,
            gameName = route.gameName,
    ...
    fun addNewPlayer(autoPosition: Int = players.size + 1) {
        launchPlayerRoute(
            LogPlayerActivity.addPlayerRoute(
    ...
    fun editPlayer(position: Int) {
        ...
        launchPlayerRoute(
            LogPlayerActivity.editPlayerRoute(
                requestId = UUID.randomUUID().toString(),
