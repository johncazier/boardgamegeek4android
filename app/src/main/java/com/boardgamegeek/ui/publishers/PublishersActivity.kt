...
@AndroidEntryPoint
class PublishersActivity : ComponentActivity() {
                ...
                Scaffold(
                                ...
                                Box {
                                    ...
                                    DropdownMenu(
                                        ...
                                        DropdownMenuItem(
                                            ...
                                            onClick = {
                                                startActivity(Intent(this@PublishersActivity, SearchResultsActivity::class.java))
                                                showOverflowMenu = false
                                            }
                                        )
                                    }
                    ...
                    PublishersScreen(
                        ...
                        onPublisherClick = { publisher ->
                            PersonActivity.startForPublisher(this, publisher.id, publisher.name)
                        }
                    )
                }
            }
