...
import com.boardgamegeek.ui.MechanicActivity
                ...
                Scaffold(
                                ...
                                Box {
                                    ...
                                    DropdownMenu(
                                        ...
                                        DropdownMenuItem(
                                            ...
                                            onClick = {
                                                startActivity(Intent(this@MechanicsActivity, SearchResultsActivity::class.java))
                                                showOverflowMenu = false
                                            }
                                        )
                                    }
                    ...
                    MechanicsScreen(
                        ...
                        onMechanicClick = { mechanic ->
                            MechanicActivity.start(this, mechanic.id, mechanic.name)
                        }
                    )
                }
            }
