...
fun LogPlayerRouteScreen(
    ...
    val initialPlayer = remember(route) {
        route.player.toPlayPlayer().let { initial ->
            if (route.autoPosition != LogPlayerLauncher.INVALID_POSITION && initial.startingPosition.isBlank()) {
    ...
    AppTheme {
        LogPlayerScreen(
            ...
            player = player,
            position = route.playerPosition,
            hasAutoPosition = route.autoPosition != LogPlayerLauncher.INVALID_POSITION,
    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                if (position != LogPlayerLauncher.INVALID_POSITION && !isNewPlayer) {
                    Text(
