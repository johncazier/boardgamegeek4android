...
fun CategoryRouteScreen(
    ...
    LaunchedEffect(route.categoryId) {
        viewModel.setId(route.categoryId)
    }
        ...
        Scaffold(
                        ...
                        Box {
                            ...
                            DropdownMenu(
                                ...
                                DropdownMenuItem(
                                    ...
                                    onClick = {
                                        context.linkToBgg("boardgamecategory", route.categoryId)
                                        showMenu = false
                                    },
                                )
                            }
            ...
            LinkedCollectionScreen(
                ...
                emptyMessage = stringResource(
                    ...
                    stringResource(R.string.title_category).lowercase(Locale.getDefault()),
                ),
